...
class ArchivePageWidget extends StatefulWidget {
  ...
  static String routePath = '/archivePage';
              ...
              Column(
                ...
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(80, 15, 0, 20),
                            child: Text(
                              'Історія',
                  ...
                  Expanded(
                    child: Builder(
                      builder: (context) {
                        final archivedItem = FFAppState().archiveList.toList();

                        return ListView.builder(
                          padding: EdgeInsets.zero,
                          shrinkWrap: true,
                          scrollDirection: Axis.vertical,
                          itemCount: archivedItem.length,
                          itemBuilder: (context, archivedItemIndex) {
                            final archivedItemItem =
                                archivedItem[archivedItemIndex];
                            return Column(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                Align(
                                              ...
                                              Expanded(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      valueOrDefault<String>(
                                                        '${archivedItemItem.dose.toString()} ${archivedItemItem.typeIcon}',
                                                        'Доза і тип',
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
